...
public class BaseController {
    ...
    public String welcome(ModelMap model,@RequestHeader("CT_REMOTE_USER") String ctUser) {
    ...
    public @ResponseBody Person movePerson(ModelMap model,@RequestHeader("CT_REMOTE_USER") String ctUser, @RequestParam String attr1) {
       ...
       // JsonParser parser = new JsonParser();
        //JSONObject json = (JSONObject) parser.parse(personString);
      //  model.addAttribute("personJson", json);
